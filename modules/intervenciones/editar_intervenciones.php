...
// --- 1. Validar que se reciba el ID de la intervencion ---
...
<head>
    ...
    <title>Editar Intervención #<?php echo htmlspecialchars($id_intervencion); ?></title>
        ...
        <div class="main">
            ...
            <div class="diagnosticos-container" style="min-height: 85vh;">
                <div class="header-section">
                    <h2 class="section-title">Editar Intervención de <?php echo htmlspecialchars($beneficiario_nombre); ?></h2>
                ...
                <div class="form-pagination-container">
                    <form id="editIntervencionForm" action="actualizar_intervencion.php" method="POST">
                        <input type="hidden" name="id_intervencion" value="<?php echo $id_intervencion; ?>">
                        ...
                        <div class="form-page is-active" data-page="1">
                            ...
                            <div class="readonly-fields-group" style="display: flex; gap: 15px; margin-bottom: 10px;">
                                <label style="flex:1;"><span>N° Intervención:</span>
                                    <input type="text" value="<?php echo htmlspecialchars($intervencion['numero_intervencion']); ?>" readonly name="numero_intervencion" tyle="background-color:#f0f0f0; font-weight: 700;">
                                </label>
                            ...
                            <label><span>Fecha de Implementación:</span>
                                <input type="date" name="fecha_implementacion" required value="<?php echo htmlspecialchars($intervencion['fecha_implementacion']); ?>">
                            </label>

                            <label><span>Tipo de Intervención:</span>
                                <select name="tipo_intervencion" required>
                                    <?php
                                    $tipos = ['Apoyo Académico', 'Orientación Psicológica', 'Terapia del Lenguaje', 'Apoyo Tecnológico', 'Mentoría', 'Otro'];
                                    foreach ($tipos as $tipo) {
                                        $sel = ($intervencion['tipo_intervencion'] == $tipo) ? "selected" : "";
                            ...
                            <label><span>Profesional Responsable:</span>
                                <input type="text"
                                    ...
                                    value="<?php
                                            foreach ($profesionales as $p) {
                                                if ($p['id'] == $intervencion['profesional_id']) {
                                ...
                                <input type="hidden" name="profesional_asignado_id" id="profesionalAsignadoId" value="<?php echo htmlspecialchars($intervencion['profesional_id']); ?>">
                            ...
                            <label><span>Estado:</span>
                                <select name="estado" required>
                                    <?php
                                    $estados = ["Activa", "En pausa", "Finalizada"]; // deben coincidir con la tabla
                                    foreach ($estados as $est) {
                                        $sel = ($intervencion['estado'] == $est) ? "selected" : "";
                            ...
                            <label><span>Resultados Esperados:</span>
                                <textarea name="resultados_esperados" required><?php echo htmlspecialchars($intervencion['resultados_esperados']); ?></textarea>
                            </label>

                            <label><span>Observaciones:</span>
                                <textarea name="observaciones"><?php echo htmlspecialchars($intervencion['observaciones']); ?></textarea>
                            </label>
                        </div>
                    </form>
                    <div class="pagination-buttons">
                        <button type="button" class="btn-pagination btn-next" id="updateIntervencionBtn" style="margin-top: 20px;">
    ...
    <div id="successModal" class="modal">
        <div class="modal-content success">
            <div class="modal-body">
                ...
                <p>Los cambios de la interveción se han guardado correctamente.</p>
                <p>Serás redirigido al historial de intervenciones en 3 segundos.</p>
            </div>
        </div>
    </div>

    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="../../assets/js/main_editar_intervenciones.js"></script>
