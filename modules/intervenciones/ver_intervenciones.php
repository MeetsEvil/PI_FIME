    ...
    <div class="main">
        ...
        <div class="view-container">
            <div class="view-header">
                <h2 class="view-title">Información de la Intervención</h2>
            ...
            <div class="view-content">
                <div class="info-grid">
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value"><?php echo htmlspecialchars($intervencion['fecha_implementacion']); ?></span>
                        </div>

                        <div class="info-row">
                            <span class="info-label">Tipo de Intervención:</span>
                            <span class="info-value"><?php echo htmlspecialchars($intervencion['tipo_intervencion']); ?></span>
                        </div>
                    </div>

                    <!-- SECCIÓN 2: Responsable y Estado -->
                    <div class="info-section">
                        <h3>
                    ...
                    <div class="info-section" style="grid-column: 1 / -1;">
                        ...
                        <div class="info-row">
                            <span class="info-value"><?php echo nl2br(htmlspecialchars($intervencion['resultados_esperados'])); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="info-section" style="grid-column: 1 / -1;">
                        ...
                        <div class="info-row">
                            <span class="info-value"><?php echo nl2br(htmlspecialchars($intervencion['observaciones'] ?: 'Sin observaciones')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="action-buttons">
                    <a href="editar_intervenciones.php?id=<?php echo $id_intervencion; ?>" class="btn-action btn-edit">
                        <ion-icon name="create-outline"></ion-icon> Editar Intervención
                    </a>
                    <a href="historico_intervenciones.php?id=<?php echo $beneficiario_id; ?>" class="btn-action btn-cancel">
                        <ion-icon name="list-outline"></ion-icon> Ver Todas las Intervenciones
                    </a>
                </div>
            </div>
        </div>
