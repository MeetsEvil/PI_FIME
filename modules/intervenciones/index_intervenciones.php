        ...
        <div class="diagnosticos-container" style="height: auto; min-height: 740px;">
            ...
            <div class="search-container">
                ...
                <div id="actionButtonsContainer" class="action-buttons-container" style="display:none;">
                    ...
                    <button id="viewHistoryBtn" class="btn-action-main" onclick="window.location.href='historico_intervenciones.php?id=' + $('#selectedBeneficiaryId').val();">
    ...
    <script type="text/javascript">
        ...
        function buscar_ahora(query) {
            ...
            $.ajax({
                data: parametros,
                type: 'POST',
                url: 'buscador_intervenciones.php', // Apunta al script PHP
