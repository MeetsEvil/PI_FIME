...
SELECT d.id_diagnostico,
        ...
        CONCAT(p.nombre, ' ', p.apellido_paterno, ' ', p.apellido_materno) AS profesional,
        d.fecha_diagnostico,
        d.tipo_diagnostico,
        d.resultado,
        d.observaciones
FROM diagnosticos d
JOIN beneficiarios b ON d.beneficiario_id = b.id_beneficiario
JOIN profesionales p ON d.profesional_id = p.id_profesional

";

if($beneficiario_id > 0){
    $query .= " WHERE d.beneficiario_id = $beneficiario_id";
}

$query .= " ORDER BY d.id_diagnostico";
