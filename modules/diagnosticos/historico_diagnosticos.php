...
// Verificar permisos de diagnósticos
$tiene_permiso_diagnostico = ($_SESSION['rol'] === 'Administrador') || (isset($_SESSION['permiso_diagnostico']) && $_SESSION['permiso_diagnostico'] == 1);
...
<head>
    ...
    <style>
        ...
        #tablaDiagnosticos tbody tr:hover {
        ...
        #tablaDiagnosticos tbody tr:nth-child(even):hover {
            background-color: #f0f9f4 !important;
        }
        ...
        #tablaDiagnosticos thead tr:hover {
            background-color: #239358 !important;
            transform: none !important;
            box-shadow: none !important;
        }

        #tablaDiagnosticos thead th:hover {
...
<body>
        ...
        <div class="diagnosticos-container">
            <div class="header-section-tabla">
                ...
                <a href="exportar_completo2.php"
                    ...
                    <?php if ($tiene_permiso_diagnostico): ?>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2>Eliminar Seguimiento</h2>
            </div>
            <div class="modal-body">
                <p style="color: #000000; font-size: 1em;">¿Estás seguro de que deseas eliminar este registro de seguimiento?</p>
            </div>
    ...
    <div id="successDeleteModal" class="modal">
        <div class="modal-content success">
            <div class="modal-body">
                <h2 class="success-title">¡Seguimiento Eliminado!</h2>
                <p style="margin-top: 8px;">El registro de seguimiento ha sido eliminado correctamente.</p>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tablaDiagnosticos').DataTable({
                "ajax": {
                    "url": "get_diagnosticos_beneficiario.php?id=" + beneficiarioId,
                    "dataSrc": "data",
        ...
        function confirmarEliminar(id) {
            ...
            document.getElementById('btnConfirmarEliminar').href = 'eliminar_diagnostico.php?id=' + id + '&beneficiario_id=' + $('#beneficiarioId').val();
        }
