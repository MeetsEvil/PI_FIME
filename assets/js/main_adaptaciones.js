...
async function submitAdaptacionFormAjax(form) {
    ...
    try {
        ...
        globalValidationMessage.textContent = "Error al guardar la adaptación: " + error.message;
        globalValidationMessage.style.color = "red";
        globalValidationMessage.style.fontSize = "1.1em";
        globalValidationMessage.style.marginTop = "10px";
        ...
        // Restaurar botón
        button.innerHTML = 'Guardar Adaptación <ion-icon name="checkmark-circle-outline"></ion-icon>';
