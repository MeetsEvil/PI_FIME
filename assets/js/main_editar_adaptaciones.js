...
// main_editar_adaptaciones.js
$(document).ready(function () {
    const $btn = $('#updateAdaptacionBtn');
    const $form = $('#editAdaptacionForm');
            ...
            success: function (response) {
                ...
                if (response && response.success) {
                    ...
                    setTimeout(function () {
                        ...
                        window.location.href = 'historico_adaptaciones.php?id=' + beneficiarioId;
                    }, 2000);
                } else {
